...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="book">
			...
			<!-- 图书分类   -->
			<s:action name="findAllCategory" namespace="/category" executeResult="true"></s:action>
			</div>
			<!--左栏结束-->
			...
			<div class=second_c_border1 id="recommend">
				<s:action name="findRecommendProduct" namespace="/product" executeResult="true"></s:action>
			</div>
			<!--推荐图书结束-->

			<!--热销图书开始-->
			<div class="book_c_border2" id="hot">
				<s:action name="findHotProduct" namespace="/product" executeResult="true"></s:action>
			</div>
			<!--热销图书结束-->

			<!--最新上架图书开始-->
			<div class="book_c_border2" id="new">
				<s:action name="findNewProduct" namespace="/product" executeResult="true"></s:action>
			</div>
			...
			<div class="book_right">
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
							<s:action name="findNewHotproduct" namespace="/product" executeResult="true"></s:action>
