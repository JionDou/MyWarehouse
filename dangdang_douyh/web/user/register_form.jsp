...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="${pageContext.request.contextPath}/user/registUserFirst" id="f">
				<h2>
					以下均为必填项
				</h2>
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							 <img id="num" src="${pageContext.request.contextPath}/p2/execute" onclick="document.getElementById('num').src = '${pageContext.request.contextPath}/p2/execute?'+(new Date()).getTime()"/>
							 <a onclick="document.getElementById('num').src = '${pageContext.request.contextPath}/p2/execute?'+(new Date()).getTime()">看不清楚？换个图片</a>
