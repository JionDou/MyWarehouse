...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/user/compareRandom" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：
						<span class="red"><span id="lblEmail"><s:property value="#session.addUser.email"/></span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					</div>
					...
					<div class="mess">
						<span class="write_in">输入您收到邮件中的验证码：[<s:property value="#session.randomCode"/>]</span>
